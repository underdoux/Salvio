...
return new class extends Migration
{
    ...
    public function up()
    {
        if (DB::connection()->getDriverName() === 'sqlite') {
            ...
            DB::statement("ALTER TABLE contacts MODIFY type VARCHAR(191) NOT NULL");
        }
    }
    ...
    public function down()
    {
        if (DB::connection()->getDriverName() === 'sqlite') {
            ...
            Schema::create('contacts', function (Blueprint $table) {
                $table->increments('id');
                $table->integer('business_id')->unsigned();
                $table->enum('type', ['supplier', 'customer', 'both'])->index();
            ...
            DB::statement("ALTER TABLE contacts MODIFY type ENUM('supplier', 'customer', 'both') NOT NULL");
        }
    }
};
